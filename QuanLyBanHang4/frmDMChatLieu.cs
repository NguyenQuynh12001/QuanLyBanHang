...
namespace QuanLyBanHang4
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            dgvChatLieu1.DataSource = tblCL; //Nguồn dữ liệu
            dgvChatLieu1.Columns[0].HeaderText = "Mã chất liệu";
            dgvChatLieu1.Columns[1].HeaderText = "Tên chất liệu";
            dgvChatLieu1.Columns[0].Width = 100;
            dgvChatLieu1.Columns[1].Width = 300;
            dgvChatLieu1.AllowUserToAddRows = false; //Không cho người dùng thêm dữ liệu trực tiếp
            dgvChatLieu1.EditMode = DataGridViewEditMode.EditProgrammatically; //Không cho sửa dữ liệu trực tiếp

        }

        private void mnuChatLieu_Load(object sender, EventArgs e)
        {

        }

        private void dgvChatLieu1_Click(object sender, EventArgs e)
        {
            ...
            txtMaChatLieu.Text = dgvChatLieu1.CurrentRow.Cells["MaChatLieu"].Value.ToString();
            txtTenChatLieu.Text = dgvChatLieu1.CurrentRow.Cells["TenChatLieu"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValue(); //Xóa trắng các  textbox
            txtMaChatLieu.Enabled = true; //cho phép nhập mới
            txtMaChatLieu.ReadOnly = false; //cho phép nhập mới
            txtMaChatLieu.Focus();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO [dbo].[tblChatLieu] ([MaChatLieu], [TenChatLieu]) VALUES (N'"+txtMaChatLieu.Text+"', N'"+txtTenChatLieu.Text+"')";
